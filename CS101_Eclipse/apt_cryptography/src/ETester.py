        ...
        def work(self):
                ...
                try:
                        while True:
                                ...
                                def inner():
                                        try:
                                                self.result = Cryptography.encrypt(copy.copy(a))
                                ...
                                self.typeOk = type(self.result) == types.LongType
                                expected = p.matchLong(self.result)
                                ...
                                if not self.done or not self.resultReturned or not self.typeOk:
                                        ...
                                        if self.runtime:
                                                ...
                                                sprinter.write("expected <xmp>"+str(types.LongType)+"</xmp>")
                                        else:
